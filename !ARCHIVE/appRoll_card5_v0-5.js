...
function renderCard(doc) {
  ...
  document.getElementById("charFive").value = name;
  let rollButton5A = "Roll " + dieAnum + " " + dieAtyp + " + " + dieAmod;
  let rollButton5B = "Roll " + dieBnum + " " + dieBtyp + " + " + dieBmod;
  let rollButton5C = "Roll " + dieCnum + " " + dieCtyp + " + " + dieCmod;
  let rollButton5D = "Roll " + dieDnum + " " + dieDtyp + " + " + dieDmod;
  let rollButton5E = "Roll " + dieEnum + " " + dieEtyp + " + " + dieEmod;
  let rollButton5F = "Roll " + dieFnum + " " + dieFtyp + " + " + dieFmod;
  document.querySelector(`#but5A`).innerText = rollButton5A;
  document.querySelector(`#numDieUp5A`).value = dieAnum;
  document.querySelector(`#selDieUp5A`).value = dieAtyp;
  document.querySelector(`#modDieUp5A`).value = dieAmod;
  document.querySelector(`#rollFor5A`).value = rolAtyp;
  document.querySelector(`#but5B`).innerText = rollButton5B;
  document.querySelector(`#numDieUp5B`).value = dieBnum;
  document.querySelector(`#selDieUp5B`).value = dieBtyp;
  document.querySelector(`#modDieUp5B`).value = dieBmod;
  document.querySelector(`#rollFor5B`).value = rolBtyp;
  document.querySelector(`#but5C`).innerText = rollButton5C;
  document.querySelector(`#numDieUp5C`).value = dieCnum;
  document.querySelector(`#selDieUp5C`).value = dieCtyp;
  document.querySelector(`#modDieUp5C`).value = dieCmod;
  document.querySelector(`#rollFor5C`).value = rolCtyp;
  document.querySelector(`#but5D`).innerText = rollButton5D;
  document.querySelector(`#numDieUp5D`).value = dieDnum;
  document.querySelector(`#selDieUp5D`).value = dieDtyp;
  document.querySelector(`#modDieUp5D`).value = dieDmod;
  document.querySelector(`#rollFor5D`).value = rolDtyp;
  document.querySelector(`#but5E`).innerText = rollButton5E;
  document.querySelector(`#numDieUp5E`).value = dieEnum;
  document.querySelector(`#selDieUp5E`).value = dieEtyp;
  document.querySelector(`#modDieUp5E`).value = dieEmod;
  document.querySelector(`#rollFor5E`).value = rolEtyp;
  document.querySelector(`#but5F`).innerText = rollButton5F;
  document.querySelector(`#numDieUp5F`).value = dieFnum;
  document.querySelector(`#selDieUp5F`).value = dieFtyp;
  document.querySelector(`#modDieUp5F`).value = dieFmod;
  document.querySelector(`#rollFor5F`).value = rolFtyp;
}
...
function save() {
  db.collection("card5").doc(`67lAtI6ixF4KXBYn6JV5`).update({
    name: charFive.value,
    rolAtyp: rollFor5A.value,
    dieAnum: numDieUp5A.value,
    dieAtyp: selDieUp5A.value,
    dieAmod: modDieUp5A.value,
    rolBtyp: rollFor5B.value,
    dieBnum: numDieUp5B.value,
    dieBtyp: selDieUp5B.value,
    dieBmod: modDieUp5B.value,
    rolCtyp: rollFor5C.value,
    dieCnum: numDieUp5C.value,
    dieCtyp: selDieUp5C.value,
    dieCmod: modDieUp5C.value,
    rolDtyp: rollFor5D.value,
    dieDnum: numDieUp5D.value,
    dieDtyp: selDieUp5D.value,
    dieDmod: modDieUp5D.value,
    rolEtyp: rollFor5E.value,
    dieEnum: numDieUp5E.value,
    dieEtyp: selDieUp5E.value,
    dieEmod: modDieUp5E.value,
    rolFtyp: rollFor5F.value,
    dieFnum: numDieUp5F.value,
    dieFtyp: selDieUp5F.value,
    dieFmod: modDieUp5F.value,
  });
}
